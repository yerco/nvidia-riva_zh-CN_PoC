...
import myapp.riva_api.riva_asr_pb2_grpc as rasr_srv
...
class ASRPipe(object):
    ...
    def listen_print_loop(self, responses):
        ...
        for response in responses:
            ...
            if not result.is_final:
                ...
                print("Not final transcript:", transcript)
            else:
                if self.verbose:
    ...
    def main_asr(self):
        ...
        config = rasr.RecognitionConfig(
            ...
            language_code="zh-CN",  #self.language_code,
            max_alternatives=1,
            enable_automatic_punctuation=self.enable_automatic_punctuation,
            verbatim_transcripts=False
        )

        # boosting characters as chinese has many homophones
        #speech_context = rasr.SpeechContext(phrases=['汉语', '名字', '词典', '语言', '音乐', '车票', '自己', '好看', '厉害', '上海', '北京'], boost=50.0)
